...
Value Endgame<KBNK>::operator()(const Position& pos) const {
  ...
  Square strongKing   = pos.square<KING>(strongSide);
  Square strongBishop = lsb(pos.pieces(BISHOP));
  Square weakKing     = pos.square<KING>(weakSide);
...
Value Endgame<KPK>::operator()(const Position& pos) const {
  ...
  Square strongPawn = normalize(pos, strongSide, lsb(pos.pieces(PAWN)));
...
Value Endgame<KRKP>::operator()(const Position& pos) const {
  ...
  Square strongKing = pos.square<KING>(strongSide);
  Square weakKing   = pos.square<KING>(weakSide);
  Square strongRook = lsb(pos.pieces(ROOK));
  Square weakPawn   = lsb(pos.pieces(PAWN));
...
Value Endgame<KRKN>::operator()(const Position& pos) const {
  ...
  Square weakKing   = pos.square<KING>(weakSide);
  Square weakKnight = lsb(pos.pieces(KNIGHT));
...
ScaleFactor Endgame<KQKRPs>::operator()(const Position& pos) const {
  ...
  Square strongKing = pos.square<KING>(strongSide);
  Square weakKing   = pos.square<KING>(weakSide);
  Square weakRook   = lsb(pos.pieces(ROOK));
...
ScaleFactor Endgame<KRPKB>::operator()(const Position& pos) const {
  ...
  {
      Square weakKing = pos.square<KING>(weakSide);
      Square weakBishop = lsb(pos.pieces(BISHOP));
      Square strongKing = pos.square<KING>(strongSide);
      Square strongPawn = lsb(pos.pieces(PAWN));
